...
I'm using an Adafruit breakout board with the Pimoroni library for their breakout board. Both boards are functionally identical, the only relevant difference between them is the default I2C address so I need to specify that when I create the instance.
